...
<html>
  ...
  <div class="timeline">
    <div class="timeline__group">
      <span class="timeline__year time" aria-hidden="true">Tricked Bug</span>
      <div class="timeline__cards">
        <div class="timeline__card card">
          ...
          <div class="card__content">
            <p>This event consists of computing level MCQ's and programming questions(write a program for given questions)</p>
          </div>
        </div>
      </div>
    </div>
    <div class="timeline__group">
      ...
      <div class="timeline__cards">
        <div class="timeline__card card">
          ...
          <div class="card__content">
            <p>&#x2022;It is a team contest, minimum of 2 and maximum of 4 members.</p>
            ...
            <h3>First round </h3>
            <p>&#x2022;This round contains Basic computing level questions.</p>
            <p>&#x2022;This round contains 25 questions.</p>
            <h3>Second round </h3>
            <p>&#x2022;Programming round (write the code for the given program) conducted via Hacker rank.</p>
            <p>&#x2022;Any language preference.</p>
            <p>&#x2022;It contains totally three questions.</p>
          </div>
        </div>
      </div>
    </div>
...
.timeline{
  --uiTimelineMainColor: var(--timelineMainColor, red);
...
body{
  background-image:url(../___sources/_t2.jpg);
