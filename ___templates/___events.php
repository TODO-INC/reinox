  ...
  <h2 class="headerx" style="color: #9c00ff;background-image: -webkit-linear-gradient(92deg, #13ffff, #ac00ff);">TECHNICAL EVENTS</h2><br><br>
    ...
    <div class="row eve card-grids center">
      <div class="col-md-2 col-sm-4 col-xs-6 width-99 center">
        <a class="cardy" href="___details/t5.php">
          ...
          <div class="card__content">
            <p class="card__heading">Paper Presentation</p>
          </div>
        </a>
      </div>
      ...
      <div class="col-md-2 col-sm-4  col-xs-6 width-99 center">
        ...
        <div class="card__content">
          <p class="card__heading">Code Corner</p>
        </div>
        </a>
      </div>
      ...
      <a class="cardy" href="___details/t2.php">
        ...
        <div class="card__content">
          <p class="card__heading">Tricked Bug</p>
        </div>
      </a>
      ...
      <a class="cardy" href="___details/t4.php">
        ...
        <div class="card__content">
          <p class="card__heading">Brain Teaser</p>
        </div>
      </a>
      </div>
      ...
      <a class="cardy" href="___details/t3.php">
        ...
        <div class="card__content">
          <p class="card__heading">Hozan Ji</p>
        </div>
      </a>
      </div>
    ...
    <br><br><br>
    <div class="row eve card-grids center">
 <br> <h2 class="headerx " style="color: #2637ff;background-image: -webkit-linear-gradient(92deg, #00ff58, #2637ff);">NON TECHNICAL EVENTS</h2> <br><br>     

      <div class="col-md-2 col-sm-4 col-xs-6 center">
        <a class="cardy" href="___details/nt2.php">
          <div class="card__background" style="background-image: url(___sources/nt2.png)"></div>
          <div class="card__content">
            <p class="card__heading">Shout in Silence</p>
          </div>
        </a>
      </div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 center">
        <a class="cardy" href="___details/nt1.php">
          ...
          <div class="card__content">
            <p class="card__heading">Dare to Prove</p>
          </div>
        </a>
      </div>
      <div class="col-md-2 col-sm-4 col-xs-6 center">
