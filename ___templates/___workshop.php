<br>
<div class="evetite" style="color: #195190FF;text-shadow: 3px 3px 2px #A2A2A1FF;">DAY 1 - 10th FEB 2k23</div>
<br>
<div class="works">
<article class="product-card col-lg-6 col-md-7x col-sm-7 col-xs-8">
  ...
  <div class="product-card__content center">
    ...
    <p class="product-card__text">Technical Workshop on Artificial Intelligence &amp; Machine Learning</p>
      <button class="form-button" onclick="window.location.href = '___details/workshop.php';"type="button" target="blank">more information</button>
  </div>
  </div>
<br><br>